...
insert into ect values('하와이', '오하우','민속촌,목장','와이키키 호텔');
insert into ect values('미국', 'LA', '유람선 등',null);
insert into ect values('터키', '터키','소금호수 등',null);
insert into ect values('싱가포르','싱가포르','유니버셜스튜디오','알렉산드라');
insert into ect values('이탈리아','루체른','콜로세움 등',null);
